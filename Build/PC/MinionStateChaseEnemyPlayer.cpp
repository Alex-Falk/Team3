...
MinionStateChaseEnemyPlayer::MinionStateChaseEnemyPlayer()
{
}

MinionStateChaseEnemyPlayer* MinionStateChaseEnemyPlayer::GetInstance()
{
	if (!instance)
	{
		instance = new MinionStateChaseEnemyPlayer;
		instance->stateName = "ChaseEnemyPlayer";
	}

	return instance;
}

void MinionStateChaseEnemyPlayer::Enter(Minion* pMinion)
{
...
void MinionStateChaseEnemyPlayer::Exit(Minion* pMinion)
{
...
void MinionStateChaseEnemyPlayer::Execute(Minion* pMinion)
{
	if (pMinion->IsAlive())
	{
		...
		else if (pMinion->DistanceToClosestEnemy() > pMinion->DistanceToEnemyZone())
		{
...
void MinionStateChaseEnemyPlayer::Release()
{
	if (instance)
	{
		delete instance;
